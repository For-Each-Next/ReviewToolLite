...
`;
  ...
  var mountedApp;
  var imeListenersInstalled;
  var isImeComposing;
  var imeResetTimer;
  var lastCompositionAt;
  var MOUNT_ID;
  var CLOSE_DELAY_MS;
  ...
  var REFERENCE_MARKER_SELECTOR;
  var REFERENCE_CONTROLS_SELECTOR;
  var escapeWikitext;
  var validRevision;
...
${reviewText}`);
  ...
  var _defineComponent2;
  var ref2;
  var computed2;
  var onMounted;
  var onUnmounted;
  var __sfc__2;
  var annotation_viewer_default;
  ...
  var ANNOTATION_CONTAINER_CLASS;
  var SENTENCE_CLASS;
  var SENTENCE_SELECTOR;
  var INLINE_TAGS;
  ...
  var inlineAnnotationBubbles;
  var removeArticleInteractions;
  var annotationModeActive;
  var annotationActivationPending;
  var REVIEWTOOL_PORTLET_ID;
